          ...
          <div class="card-body">
            ...
            <form action="{{ url('admin/loan_plan/edit/'.$getRecord->id) }}" method="post" enctype="multipart/form-data">
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" id="mobileNumber" name="months" value="{{ $getRecord->months }}" class="form-control"
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" id="mobileNumber" name="interest_percentage" value="{{ $getRecord->interest_percentage }}" class="form-control"
                    oninput="javascript : this.value =
                    this.value.replace(/[^0-9]/g,''); if(this.value.length > this.maxLength)
                    this.value=this.value.slice(0,this.maxLength);" maxLength="10">
                </div>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" id="mobileNumber" name="penalty_rate" value="{{ $getRecord->penalty_rate }}" class="form-control"
                    oninput="javascript : this.value =
                    this.value.replace(/[^0-9]/g,''); if(this.value.length > this.maxLength)
