          ...
          <div class="card-body">
            ...
            <form action="{{ url('admin/loan_user/edit/'.$getRecord->id) }}" method="post" enctype="multipart/form-data">
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input required type="text" id="first_name" name="first_name" value="{{ old('first_name',$getRecord->first_name) }}" class="form-control">
                </div>
              </div>
              <div class="row mb-3">
                <label for="middle_name" class="col-sm-2 col-form-label">Middle Name <span style="color:red;">*</span></label>
                <div class="col-sm-10">
                    <input required type="text" id="middle_name" name="middle_name" value="{{ old('middle_name',$getRecord->middle_name) }}" class="form-control">
                </div>
              </div>
              <div class="row mb-3">
                <label for="last_name" class="col-sm-2 col-form-label">Last Name <span style="color:red;">*</span></label>
                <div class="col-sm-10">
                    <input required type="text" id="last_name" name="last_name" value="{{ old('last_name',$getRecord->last_name) }}" class="form-control">                </div>
              </div>
              <div class="row mb-3">
                <label for="address" class="col-sm-2 col-form-label">Address <span style="color:red;">*</span></label>
                <div class="col-sm-10">
                    <textarea id="address" name="address" class="form-control">
                         {{ old('address',$getRecord->address) }}
                    </textarea>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input required type="text" id="contact" name="contact" value="{{ old('contact',$getRecord->contact) }}" class="form-control"
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input required type="text" id="email" name="email" value="{{ old('email',$getRecord->email) }}" class="form-control">
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input required type="text" id="tax_id" name="tax_id" value="{{ old('tax_id',$getRecord->tax_id) }}" class="form-control">                </div>
              </div>
